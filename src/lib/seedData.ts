...
export const seedItems: Item[] = [
  ...
  { id:'i-sword_iron',       key:'sword_iron',       name_ru:'Железный меч',        name_en:'Iron sword',       slot:'weapon',     rarity:'common',    price_gold:150,  effects:{ xp_mult:1.05 }, icon:'S' },
  { id:'i-sword_silver',     key:'sword_silver',     name_ru:'Серебряный меч',      name_en:'Silver sword',     slot:'weapon',     rarity:'rare',      price_gold:400,  effects:{ xp_mult:1.10 }, icon:'S' },
  { id:'i-sword_dragon',     key:'sword_dragon',     name_ru:'Меч дракона',         name_en:'Dragon sword',     slot:'weapon',     rarity:'epic',      price_gold:1200, effects:{ xp_mult:1.20 }, icon:'S' },
  { id:'i-armor_leather',    key:'armor_leather',    name_ru:'Кожаная броня',       name_en:'Leather armor',    slot:'armor',      rarity:'common',    price_gold:150,  effects:{ damage_mult:0.90 }, icon:'A' },
  { id:'i-armor_steel',      key:'armor_steel',      name_ru:'Стальная броня',      name_en:'Steel armor',      slot:'armor',      rarity:'rare',      price_gold:420,  effects:{ damage_mult:0.80 }, icon:'A' },
  { id:'i-helmet_focus',     key:'helmet_focus',     name_ru:'Шлем фокуса',         name_en:'Focus helmet',     slot:'helmet',     rarity:'rare',      price_gold:320,  effects:{ focus:5 }, icon:'H' },
  { id:'i-boots_swift',      key:'boots_swift',      name_ru:'Сапоги скорости',     name_en:'Swift boots',      slot:'boots',      rarity:'common',    price_gold:120,  effects:{ extra_skips_per_week:1 }, icon:'B' },
  { id:'i-amulet_luck',      key:'amulet_luck',      name_ru:'Амулет удачи',        name_en:'Lucky amulet',     slot:'amulet',     rarity:'epic',      price_gold:900,  effects:{ rare_drop_bonus:0.05 }, icon:'M' },
  { id:'i-book_wisdom',      key:'book_wisdom',      name_ru:'Книга мудрости',      name_en:'Book of wisdom',   slot:'book',       rarity:'rare',      price_gold:280,  effects:{ category_bonus:{ study:1.15, reading:1.15 } }, icon:'K' },
  { id:'i-gadget_timer',     key:'gadget_timer',     name_ru:'Помодоро-таймер',     name_en:'Pomodoro timer',   slot:'gadget',     rarity:'common',    price_gold:90,   effects:{ category_bonus:{ work:1.10 } }, icon:'T' },
  { id:'i-tool_journal',     key:'tool_journal',     name_ru:'Дневник дисциплины',  name_en:'Discipline journal',slot:'tool',      rarity:'rare',      price_gold:260,  effects:{ category_bonus:{ discipline:1.20 } }, icon:'J' },
